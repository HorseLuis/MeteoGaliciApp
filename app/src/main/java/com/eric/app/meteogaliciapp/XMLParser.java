        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (xpp.getName().equals("ceoN")){
                        ceoN = xpp.nextText();
                    }
                    if (xpp.getName().equals("pChoivaM")){
                        pChoivaM = xpp.nextText();
                    }
                    if (xpp.getName().equals("pChoivaT")){
                        pChoivaT = xpp.nextText();
                    }
                    if (xpp.getName().equals("pChoivaN")){
                        pChoivaN = xpp.nextText();
                        tiempo1 = new Tiempo(data1, tMax, tMin, ceoM, ceoT, ceoN, pChoivaM, pChoivaT, pChoivaN);
